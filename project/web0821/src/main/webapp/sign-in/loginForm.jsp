...
<html lang="ko" data-bs-theme="auto">
  <head><script type = "text/javascript" src="${pageContext.request.contextPath}/assets/js/color-modes.js"></script>
...
<link href="${pageContext.request.contextPath}/assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body class="align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin m-auto">
      <form action = "loginAction" method="post" style="display: inline;">
    ...
    <br>
    <button class="btn btn-primary w-100 py-2" style="margin-bottom:5px;" type="submit">로그인</button>
    <button class="btn btn-danger w-100 py-2" type="reset" style="margin-bottom:5px;">초기화</button>
	</form>
    <button class="btn btn-success w-100 py-2" style="margin-bottom:5px;" onclick="location.href='join'">회원가입</button>
